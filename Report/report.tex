...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{media/rule-of-two.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{media/solution-architecture.png}
